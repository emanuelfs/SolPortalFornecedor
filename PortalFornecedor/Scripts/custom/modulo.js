...
metodoGet = 'Modulo/Get';
metodoInsert = 'Modulo/Insert';
...
$(document).ready(function () {
    ...
    $('#btnExportarExcel').click(function () {
        exportarArquivo('Modulo/GetParaExcel', 'Modulo/ExportarExcel', 'Modulos');
    });
